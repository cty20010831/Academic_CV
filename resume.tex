...
{\bf Columbia University} \hfill {Sept 2026--Expected Jun 2031} \\
{\textit{Doctor of Philosophy in Neurobiology and Behavior}} \hfill {\textit{GPA: NA}} \\
\vspace{-0.1em} \\ 
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
Coursework 
& Survey of Neuroscience, Introduction to Theoretical Neuroscience \\
& Neurobio I: Cellular and Molecular, Research in Neurobiology \\
\vspace{-0.2em} \\ 
Honors & NIH Neurobiology and Behavior Training Grant (T32NS115699), Columbia University
\end{tabular}
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
Coursework 
& Introduction to AI: Deep Learning and GAI, Mathematical Foundations of Machine Learning \\ 
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
Coursework 
& Cognitive Psychology, Abnormal Psychology, Decision-Making Process, \\
...
\textbf{\href{https://vivo.brown.edu/display/aarulpra}{Department of Psychiatry and Human Behavior}, Warren Alpert Medical School} \hfill{Sept 2025--Present} \\
\textit{Part-Time Research Assistant (Principal Investigator: Dr. Amanda Arulpragasam)} \hfill{\textit{Rhode Island, Providence}}
 \begin{itemize}
    \itemsep -5pt {} 
        \item \textbf{Contribute} to a translational neuromodulation project testing whether TMS targeting prefrontal control circuitry can improve motivated cognitive effort and reward-related decision-making in individuals with major depressive disorder. 
        \item \textbf{Process} trial-level Stroop data to derive accuracy, reaction time, and response-rate outcomes across reward value and efficacy conditions. 
        \item \textbf{Analyze} pre/post TMS behavioral data from a customized motivated cognitive effort task in R, focusing on behavioral metrics including response time, accuracy, and normalized response rate.
        \item \textbf{Implement} hierarchical drift-diffusion modeling in Python-based HDDM to examine computational mechanisms underlying TMS-related changes in motivated cognitive effort.
 \end{itemize}

\textbf{\href{https://cdasr.mclean.harvard.edu/mlml/}{Motivated Learning and Memory Laboratory}, McLean Hospital} \hfill{Jul 2025--Jul 2026} \\
\textit{Part-Time Research Assistant (Principal Investigator: Dr. Daniel Dillon)} \hfill{\textit{Boston, Massachusetts}}
 \begin{itemize}
    \itemsep -5pt {} 
     \item \textbf{Elucidated} whether anhedonia in major depressive disorder (MDD) reflects a general reinforcement learning (RL) deficit or a selective impairment in updating from positive (vs. negative) feedback.
     \item \textbf{Tested} hypothesized slower RL from positive outcomes related to anhedonia across two community samples and one sample of MDD and healthy control (HC) individuals. 
     ...
     \item \textbf{Conducted} ongoing fMRI analyses combining whole-brain contrasts, RL-DDM–based parametric modulators, and reward-network Region of Interest (ROI) tests to map group differences in reinforcement-learning signals between MDD and HC participants. 
     ...
     \item \textbf{Co-authored} the methods and results sections in the final manuscript. 
 \end{itemize}
...
\begin{itemize}
    ...
    \item \textit{JMIR Neurotechnology}
\end{itemize}
